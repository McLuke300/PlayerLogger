...
public class filehandler {
	...
	public static void logLogin(String playername, String worldname, double x,
			double y, double z, String ip, Boolean staff, Boolean lowercase) {
		if (lowercase) {
	...
	public static void logQuit(String playername, String worldname, double x,
			double y, double z, Boolean staff, Boolean lowercase) {
		if (lowercase) {
			playername = playername.toLowerCase();
		}
		File user;
	...
	public static void logChat(String playername, String msg, String worldname,
			double x, double y, double z, Boolean staff, Boolean lowercase) {
		if (lowercase) {
			playername = playername.toLowerCase();
		}
		File user;
	...
	public static void logPlayerDeath(String playername, String reason,
			String worldname, double x, double y, double z, Boolean staff, Boolean lowercase) {
		if (lowercase) {
			playername = playername.toLowerCase();
		}
		File user;
	...
	public static void logEnchant(String playername,
			...
			String worldname, Boolean staff, Boolean lowercase) {
		if (lowercase) {
			playername = playername.toLowerCase();
		}
		File user;
	...
	public static void logBucket(String playername, String worldname, int x,
			int y, int z, Boolean lava, Boolean staff, Boolean lowercase) {
		if (lowercase) {
			playername = playername.toLowerCase();
		}
		File user;
	...
	public static void logSign(String playername, String worldname, int x,
			int y, int z, String[] lines, Boolean staff, Boolean lowercase) {
		if (lowercase) {
			playername = playername.toLowerCase();
		}
		File user;
	...
	public static void logKill(String player, String damager, double x,
			double y, double z, String worldname, Boolean staff, Boolean lowercase) {
		if (lowercase) {
	...
	public static void logPlace(String playername, String worldname,
			String blockname, int x, int y, int z, Boolean staff, Boolean lowercase) {
		if (lowercase) {
			playername = playername.toLowerCase();
		}
		File user;
